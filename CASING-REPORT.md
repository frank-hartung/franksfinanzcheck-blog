...
**Stand:** 2026-09-11 08:20 UTC · Modus: fix · new-only

Geprüfte Dateien: 6 · geprüfte Content-Wörter: 10.413 · Dateien mit Fund im Lauf: 2 · erkannte Funde: 6 · offene Befunde: 5 · hart (gate-würdig): 0 · automatisch geheilt: 1
...
|---|---:|---:|
| `content/posts/2026-09-11-gasrechnung-senken-warum-ich-meine-heizung-im-august-pruefe/index.md` | 1 | 1 |
...
|---|---|---|---|
| C12-guard | 160 | report | `Wie finde ich den günstigsten Stromtarif? Nutze Vergleichs` → `Ueberschrift mit angeklebtem Text (Struktur prüfen)` |
| C12-guard | 162 | report | `Muss ich bei einem Tarifwechsel sofort sparen? Der Wechsel` → `Ueberschrift mit angeklebtem Text (Struktur prüfen)` |
| C12-guard | 164 | report | `Wie oft sollte ich meine Versicherungen überprüfen? Mindes` → `Ueberschrift mit angeklebtem Text (Struktur prüfen)` |
| C12-guard | 166 | report | `Lohnt sich ein Budget‑Tool wirklich? Ja. Eine einfache App` → `Ueberschrift mit angeklebtem Text (Struktur prüfen)` |
| C12-guard | 168 | report | `Was ist die praktischste Faustregel für Notgroschen? Drei ` → `Ueberschrift mit angeklebtem Text (Struktur prüfen)` |
