...
|---|---|---|
| Artikel | 31 | — |
| ø interne Links/Artikel | 4.1 | 2–9 |
| Artikel im Korridor | 97 % | ≥ 85 % |
| unterversorgt (<2) | 1 | 0 |
| überladen (>9) | 0 | 0 |
| Ziel-Duplikate (heilbar offen) | 8 | 0 |
| Ziel-Duplikate (strukturell, unheilbar) | 1 | Info |

✅ **Selbstheilung Duplikate:** 13 Folge-Links entlinkt (Text blieb).
✅ **Selbstheilung Dichte:** 2 Artikel per Linker nachgeruestet.
  ⚠ LOW  2026-09-04-so-bekommst-du-wlan-in-jeden-winkel-repeater-oder-mesh: 1 Links
