...
- Stil-Politur auf Premium-Level (Claude, kostenlos ohne API via Puter.js, personalisiert, 25.09.2026) = `claude_stilpolitur.py` – läuft NACH dieser Offline-Optimierung, Details in `docs/ANLEITUNG-CLAUDE-STILPOLITUR.md`
