...
# Dateiname -> (Quelle, Gewicht, italic?)
FONT_PLAN = {
    "montserrat-normal-500.woff2": ("Montserrat-var.ttf", 500, False),
    "montserrat-normal-600.woff2": ("Montserrat-var.ttf", 600, False),
    "montserrat-normal-700.woff2": ("Montserrat-var.ttf", 700, False),
...
def build_one(filename, src, weight, italic):
    ...
    fam_base = "Montserrat" if "Montserrat" in font_family(f) else "Playfair Display"
    name = f["name"]
