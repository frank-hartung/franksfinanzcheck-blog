...
def main():
    ...
    body = (
        ...
        "1. **Normalfall (zweistufige Freigabe seit 13.08.):** Der Artikel hat nur "
        "das abgeschwächte Relaxed-Qualitäts-Gate erreicht (`engine_level: \"relaxed\"` "
        "im Frontmatter), nicht die härtere Profi-Schwelle – solche Artikel werden "
        "bewusst nicht automatisch veröffentlicht und warten auf deinen kurzen Blick.\n"
        "2. **Ausnahme:** Die automatische Qualitätsprüfung (oder die KI-APIs) "
        "hat auch die Relaxed-Schwelle nicht erreicht (`engine_level: \"draft\"` im "
        "Frontmatter, Ebene-3-Rettung) – dann bitte etwas gründlicher gegenlesen/nachbessern.\n\n"
        "**Bitte prüfen:**\n"
        ...
        "_Hinweis: Profi-Qualität wird weiterhin automatisch veröffentlicht – dieses "
        "Issue erscheint nur bei Relaxed-Artikeln oder Qualitäts-Rettungen. "
