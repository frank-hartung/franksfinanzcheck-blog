...
- `dispozinsen-verstehen-alternativen` — LIX 40.8
- `impulskaeufe-vermeiden-7-psychologische-tricks` — LIX 42.1
- `balkonkraftwerk-2026-lohnt-sich` — LIX 43.5
- `2026-08-14-gasrechnung-senken-fehler-im-spaetsommer-vermeiden` — LIX 44.3
- `kuehlschrank-strom-sparen-einstellung` — LIX 45.0
