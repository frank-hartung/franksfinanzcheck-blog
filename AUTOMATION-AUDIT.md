...
**P1 – bald sinnvoll:**
- [x] **Dependabot für GitHub Actions** – ERLEDIGT 2026-08-10 + **Auto-Merge** (`dependabot-automerge.yml`: Patch/Minor automatisch, Major mit Kommentar zur manuellen Prüfung) (`.github/dependabot.yml`, wöchentlich Mo 07:00 MESZ)
