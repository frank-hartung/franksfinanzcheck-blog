...
## 📉 Flop (nicht priorisieren / neu aufsetzen)

_Keine Flop-Einträge (noch zu wenig Daten)._

## 🧭 Board/Pillar-Gewichtung (für Engine)

| Pillar | Gewicht | Clicks | Impressions |
|---|---|---|---|

## 🎯 Empfehlung (Chefredakteur/Affiliate)
...
3. **Stichtag-Boost:** Sensitive Pillars (Versicherungen, Strom/Gas, DSL,   Zinsen, Mietwagen) erhalten automatisch Saison-Boost → zur richtigen
   Zeit genug Content.
