...
3. **Kündigungsfrist maximal 1 Monat:** Nach Ablauf der Erstlaufzeit verlängern sich Verträge heute nur noch auf unbestimmte Zeit mit einer monatlichen Kündigungsfrist.
4. **Keine Vorkasse oder Kaution:** Seriöse Anbieter rechnen monatlich per Abschlag ab. Vermeide Anbieter, die Vorauszahlungen für das ganze Jahr verlangen.
5. **Transparente Boni-Regelung:** Ein Sofortbonus wird meist nach wenigen Wochen ausgezahlt, während ein Neukundenbonus oft erst mit der ersten Jahresrechnung verrechnet wird.
6. **Kundenbewertungen & Service:** Bevorzuge Anbieter mit einer Weiterempfehlungsquote von mindestens 85 % auf großen Bewertungsportalen. Achte darauf, dass der Kundenservice telefonisch oder per Chat gut erreichbar ist.
