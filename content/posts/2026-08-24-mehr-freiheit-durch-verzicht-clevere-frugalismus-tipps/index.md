...
In Großstädten liegt der Anteil für Miete häufig bei 40 % – 45 % des Nettoeinkommens. Dann empfiehlt sich die **60‑25‑15‑Variante** (siehe unten). Wichtig ist, dass du die Sparquote nicht aus den Augen verlierst – sie ist das Kernstück der **Finanziellen Freiheit**.
...
## Pro & Contra von Frugalismus

| Vorteil | Nachteil |
|:---|:---|
| **Mehr finanzielle Puffer** – Notgroschen schneller aufgebaut | **Sozialer Druck** – Freunde können das sparsame Verhalten als „Geiz“ missverstehen |
| **Zeitgewinn** – weniger Zeit für Shopping, mehr für Hobbys | **Initialer Aufwand** – Analyse der Ausgaben kostet Zeit und Disziplin |
| **Bessere Entscheidungen** – bewusster Konsum, weniger Fehlkäufe | **Einschränkung bei Luxusgütern** – teure Reisen oder Markenartikel müssen ggf. verschoben werden |
| **Umwelt‑Benefit** – weniger Konsum, weniger Ressourcenverbrauch | **Gefahr der Über‑Sparsamkeit** – zu starkes Kürzen kann die Lebensqualität mindern |

Der Schlüssel liegt im **Balance‑Act**: Sparen, wo es keinen Mehrwert gibt, und investieren, wo es langfristig glücklich macht.

## Investieren, nachdem der Notgroschen steht

| Anlageform | Durchschnittliche Rendite (letzte 10 Jahre) | Liquidität | Kosten (TER) | Geeignet für |
|:---|:---|:---|:---|:---|
| **Tagesgeld** | 0,5 % – 1,5 % | Sofort verfügbar | 0 % | Notgroschen, kurzfristige Ziele |
| **ETF‑Sparplan (Welt‑ETF)** | 6 % – 8 % | 2‑3 Tage (Auszahlung) | 0,15 % – 0,30 % | Langfristiger Vermögensaufbau, Finanzielle Freiheit |
| **Aktien‑Einzelkauf** | 5 % – 12 % (stark schwankend) | 1‑2 Tage | 0,2 % – 0,5 % | Erfahrene Anleger, gezielte Themeninvestments |
| **Robo‑Advisor** | 4 % – 6 % | 1‑2 Tage | 0,25 % – 0,50 % | Anfänger, die automatisiert diversifizieren wollen |

**Praxis‑Tipp:** Sobald du 3‑6 Monatsausgaben (z. B. 4.500 €) als **Notgroschen** hast, lege den Überschuss in einen weltweiten ETF‑Sparplan. Das kombiniert Sicherheit (Tagesgeld) mit Wachstums­potenzial (ETF).

## Fallstudie: Max, 28, Software‑Entwickler

| Parameter | Wert |
|:---|:---|
| Netto‑Monatseinkommen | 2.800 € |
| Aktuelle Sparquote | 12 % (340 €) |
| Fixkosten (Miete + Nebenkosten) | 1.200 € |
| Ziel‑Sparquote (nach Frugalismus‑Umstellung) | 20 % (560 €) |
| Erwartete Rendite ETF‑Sparplan | 7 % p.a. |
...
**1. Eine In‑Liste statt einer Out‑Liste.** Schreib nicht, worauf du verzichtest. Schreib, was du behältst: wöchentliches Kochen mit Freunden, das Fahrrad, ein Streaming‑Dienst, zwei Konzerte im Jahr. Alles andere muss sich gegen diese Liste bewerben.
...
**5. Ein No‑Spend‑Weekend pro Monat.** 48 Stunden ohne Bezahlvorgänge außer vorgeplanten Tickets. Nicht als Strafe, als Diagnose: Wo zuckst du?
...
Frugalismus ist kein Verzichtsprogramm. Er ist ein Werkzeug für **Finanzielle Freiheit**. Streichst du unnötige Ausgaben und prüfst deine Verträge, hast du mehr Spielraum. Jeden Monat.
