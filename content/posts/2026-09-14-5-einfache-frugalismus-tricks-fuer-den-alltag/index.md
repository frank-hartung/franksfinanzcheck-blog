...
| Kategorie          | Typische Ausgaben pro Monat (Beispiel) | Hinweis zur Optimierung |
|--------------------|----------------------------------------|--------------------------|
| Lebensmittel       | 250 €                                   | Wochenplan erstellen, Resteverwertung |
| Mobilität          | 80 €                                    | Kombiticket, Fahrgemeinschaft |
| Streaming‑Abos    | 15 €                                    | Kündigen, wenn nicht genutzt |
...
| Maßnahme                | Erwartete Einsparung (Faustregel) | Aufwand |
|-------------------------|-----------------------------------|---------|
| Geräte komplett ausschalten (nicht nur Stand‑by) | 5 % des Stromverbrauchs | gering |
| LED‑Lampen statt Glühbirnen | 10 % des Stromverbrauchs | gering |
| Warmwasser‑Durchflussbegrenzer | 5 % des Gasverbrauchs | gering |
...
| Schritt                | Was du tun musst | Dauer |
|------------------------|------------------|-------|
| Verbrauch prüfen       | Letzte Jahresabrechnung heraussuchen | 5 Min |
| Vergleich einholen     | CHECK24‑Portal nutzen, Filter setzen | 10 Min |
| Kündigungsfrist beachten | Vertragsbedingungen prüfen (meist 2‑Wochen‑Frist) | 5 Min |
...
| Maßnahme                     | Potenzielle Einsparung (Faustregel) | Aufwand |
|------------------------------|--------------------------------------|---------|
| Wochenplan erstellen         | 10 % der Lebensmittelkosten          | gering |
| Resteverwertung (Suppen, Aufläufe) | 5 % der Lebensmittelkosten           | gering |
| Großeinkauf mit Vorratsbehältern | 7 % der Lebensmittelkosten           | mittel |
...
| Abo / Mitgliedschaft | Monatliche Kosten (Beispiel) | Nutzung pro Monat | Handlungsbedarf |
|----------------------|------------------------------|-------------------|-----------------|
| Musik‑Streaming      | 10 €                         | 2 Stunden         | kündigen oder auf Gratis‑Version wechseln |
| Fitnessstudio        | 30 €                         | 1 Besuch          | Pausieren oder günstigeren Anbieter suchen |
| Zeitschriften‑Abo    | 8 €                          | 0 Ausgabe         | kündigen |
...
|-------------------------------------|-------------------|-----------------------|
| „Spontankäufe ohne Nachdenken“      | Fehlende Ausgabenkontrolle | Nutze die 24‑Stunden‑Regel, bevor du etwas bestellst |
| „Nur den Preis, nicht den Verbrauch prüfen“ | Fokus auf monatliche Grundgebühr | Vergleiche immer den Jahresverbrauch (kWh, m³) |
| „Vertrag nicht rechtzeitig kündigen“ | Unkenntnis über Fristen | Setze dir im Kalender eine Erinnerung 30 Tage vor Ablauf |
