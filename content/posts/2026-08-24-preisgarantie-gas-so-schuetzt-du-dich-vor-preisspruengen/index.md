...
* **Feste Kalkulationsbasis:** Dein Arbeitspreis (in Cent pro kWh) und Grundpreis (in Euro pro Monat) stehen für die gesamte Vertragslaufzeit unverrückbar fest.
* **Keine Winter‑Preisschocks:** Selbst wenn die Gasbörsenpreise im tiefsten Januar explodieren, heizt du zu den im Spätsommer vereinbarten Konditionen weiter.
...
* **Schutz vor CO₂‑Preissprüngen:** Tarife mit vollständiger Festpreisbindung federn auch schrittweise Erhöhungen der gesetzlichen Emissionszertifikate für die Vertragslaufzeit ab.
...
## Vor‑ und Nachteile einer Preisgarantie

| **Aspekt** | **Vorteil** | **Möglicher Nachteil** |
|:---|:---|:---|
| **Kostenplanbarkeit** | Feste Abschlagszahlungen, keine Überraschungen | Bei stark fallenden Marktpreisen zahlst du ggf. über dem aktuellen Niveau |
...
Diese Tabelle zeigt die Kosten bei einem Preissprung im Winter. Beispiel: Einfamilienhaus mit 20.000 kWh Verbrauch.

| Tarifmodell | Arbeitspreis Normal | Arbeitspreis nach Preissprung | Reale Jahreskosten |
|:---|:---|:---|:---|
...
|:---|:---|:---|
| **Arbeitspreis (Beispiel)** | 8,80 Cent /kWh | 8,30 Cent /kWh |
| **Grundpreis** | 12 €/Monat | 11 €/Monat |
| **Durchschnittliche Jahreskosten (20.000 kWh)** | 1.760 € | 1.710 € |
| **Flexibilität** | Nach einem Jahr neu verhandeln | Zwei‑Jahres‑Bindung, Kündigung nur mit Sonderkündigungsrecht |
| **Typische Bonus** | 100 € Einmalzahlung | 150 € Einmalzahlung (häufig an 24 Monate geknüpft) |
| **Risiko bei stark fallenden Marktpreisen** | Höher, weil Preis länger fest | Noch höher, weil Preis über 2 Jahre fixiert ist |

Rechne selbst nach: **(Arbeitspreis × Verbrauch) + (Grundpreis × 12)**. So erkennst du sofort, ob die zusätzliche 0,5 Cent pro kWh die längere Bindung rechtfertigen.

## Worauf du im Kleingedruckten der Preisgarantie achten musst

Damit dein Schutz im Ernstfall trägt, prüfe die AGB des Anbieters auf diese Punkte:
...
## Praktische Tipps, um deine Heizkosten zu senken

Eine Preisgarantie schützt dich vor Preissprüngen, aber du kannst deine **[Heizkosten senken](../../posts/2026-09-07-heizkosten-senken-mit-diesen-strategien-sparst-du-sofort/)**, indem du den Verbrauch reduzierst:

| Tipp | Erwartete Einsparung (bei 20.000 kWh) |
|:---|:---|
| **Thermostat um 1 °C niedriger einstellen** | ca. 5 % → 100 € |
| **Jährliche Heizungswartung (Entlüften, Filterwechsel)** | ca. 3 % → 60 € |
| **Richtige Dämmung von Heizkörpern (Reflexionsfolie)** | ca. 2 % → 40 € |
| **Nachtabsenkung (5 °C) bei Abwesenheit** | ca. 4 % → 80 € |
| **Smart‑Meter nutzen, um Lastspitzen zu vermeiden** | ca. 1 % → 20 € |

Kombiniert kannst du mit diesen Maßnahmen leicht 10 % deiner Jahresrechnung einsparen – das entspricht rund **200 €** bei einem Verbrauch von 20.000 kWh.
...
- [ ] Jahresverbrauch (kWh) und Zählernummer notiert  
- [ ] Mindestens 12 Monate Preisgarantie im Vergleichsfilter aktiviert  
- [ ] Bonusbedingungen (Auszahlungszeitpunkt, Mindestlaufzeit) geprüft  
- [ ] AGB auf versteckte Nachjustierungsklauseln gescannt  
- [ ] Kündigungsfrist nach Garantieende notiert (max. 1 Monat)  
- [ ] Erinnerungs‑Kalendereintrag für „Garantie‑Check“ 10 Monate nach Vertragsstart  
...
## Vergleich von Top‑Anbietern 2024 (nach Gasvergleich)

| Anbieter | Preisgarantie | Arbeitspreis (Cent/kWh) | Grundpreis (€/Monat) | Bonus (Einmal) | Kunden‑Score (von 5) |
|:---|:---|:---|:---|:---|:---|
...
- „Anpassung bei Änderung der gesetzlichen Abgaben“ ohne Obergrenze  
- Garantie nur auf den Energieeinkauf, nicht auf Netzentgelte  
- Boni, die als Gutschrift in Monat 13 kommen – und verfallen, wenn du vorher gehst  
- Paketpreise mit Strom + Gas, bei denen die Gas‑Garantie kürzer ist als die Strom‑Bindung  
...
### Wie unterscheidet sich eine Preisgarantie von einer Preisfixierung?
Die Anbieter nutzen beide Begriffe meist gleich. Wichtig ist nur, welche Kosten im Vertrag garantiert fest sind: Energie, Netzentgelte, Steuern.

### Was passiert, wenn der Gaspreis am Markt sinkt?
Dein Preis bleibt für die vereinbarte Laufzeit fest, zum Beispiel 12 Monate. Danach wechselst du mit vier Wochen Frist in einen günstigeren Tarif.

### Gilt das Sonderkündigungsrecht bei Preiserhöhungen trotz Garantie?
Ja. Passt der Anbieter die Preise außerhalb der Garantie an, hast du nach § 41 EnWG ein Sonderkündigungsrecht.

### Wann schließe ich am besten eine Gaspreisgarantie ab?
Im Spätsommer, von August bis Oktober. Vor dem Winter sind die Preise meist günstiger als mitten in der kalten Zeit.

### Was kostet der Anbieterwechsel?
Für dich ist der Wechsel kostenlos. Weder der neue noch der alte Anbieter darf Gebühren verlangen.

### Wie lange sollte die Preisgarantie laufen?
Für die meisten Haushalte reicht eine **12‑Monats‑Garantie** aus, weil sie genug Spielraum für einen jährlichen Markt‑Check bietet. Wer sehr planbare Verbrauchszahlen hat und über ein größeres Budget verfügt, kann von einer **24‑Monats‑Garantie** profitieren – dort sinkt der Arbeitspreis, das Risiko bei stark fallenden Marktpreisen steigt jedoch.

### Kann ich meine Preisgarantie vorzeitig kündigen?
Ja, aber nur aus wichtigem Grund (z. B. Umzug ins Ausland, Anbieterinsolvenz) oder wenn der Anbieter die garantierten Preise ohne vertragliche Grundlage ändert. In diesem Fall greift das gesetzliche Sonderkündigungsrecht nach § 41 EnWG, und du kannst ohne Strafgebühr aus dem Vertrag aussteigen.
