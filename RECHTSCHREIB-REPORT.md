...
> **Automatisch** erzeugt am 2026-09-04 – 35 Artikel geprüft, 233 Funde, 12 korrigiert, 221 offen.

## Offene Punkte

- `Unbekanntes Wort: „Fitness-Apps“ (Vorschläge: –)`
- `Unbekanntes Wort: „Coupon-App“ (Vorschläge: –)`
- `Unbekanntes Wort: „Minderungsanspruch“ (Vorschläge: –)`
- `Unbekanntes Wort: „Board“ (Vorschläge: –)`
- `Unbekanntes Wort: „Call“ (Vorschläge: –)`
- `Unbekanntes Wort: „Eigentümerversammlung“ (Vorschläge: –)`
- `Unbekanntes Wort: „Banking-Silo“ (Vorschläge: –)`
- `Unbekanntes Wort: „Lifestyle-Finanzierung“ (Vorschläge: –)`
- `Unbekanntes Wort: „Phishing“ (Vorschläge: –)`
- `Unbekanntes Wort: „herausgibt“ (Vorschläge: –)`
- `Unbekanntes Wort: „Stornogebühr“ (Vorschläge: –)`
- `Unbekanntes Wort: „Kamera-App“ (Vorschläge: –)`
- `Unbekanntes Wort: „Mittelklassewagen“ (Vorschläge: –)`
- `Unbekanntes Wort: „Standby-Stromfresser“ (Vorschläge: –)`
- `Unbekanntes Wort: „Umwälzpumpen“ (Vorschläge: –)`
- `Unbekanntes Wort: „App-Affinität“ (Vorschläge: –)`
- `Unbekanntes Wort: „Board-Routing“ (Vorschläge: –)`
- `Unbekanntes Wort: „sakrosankt“ (Vorschläge: –)`
- `Unbekanntes Wort: „überversichert“ (Vorschläge: –)`
- `Unbekanntes Wort: „Präventionsmaßnahmen“ (Vorschläge: –)`
